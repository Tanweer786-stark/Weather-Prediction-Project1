    // ====== CONFIG ======
    const API_KEY = "735b384d7e24488fb6b50538253008";
    ...
    async function fetchAndRender(location){
      ...
      try{
        ...
        console.error(err);
        alert("Failed to fetch weather. Please check the location name and try again.");
        el.airQuality.innerHTML = `<div style="color:var(--muted)">No data available</div>`;
      }
    }
